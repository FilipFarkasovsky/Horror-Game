...
public class PlayerInput : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        Vector3 localVelocity = Quaternion.Euler(0, transform.rotation.eulerAngles.y - playerCameracamera.transform.rotation.eulerAngles.y, 0) * new Vector3(velocity.x, 0, velocity.z);
